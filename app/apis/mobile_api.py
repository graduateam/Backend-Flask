...
def _get_real_cctv_coverage_data():
    ...
    try:
        ...
        geo_corners = [
            [126.73485573, 37.33867727],  # 좌상단
            [126.73407843, 37.33913435],  # 우상단  
            [126.73488429, 37.33945447],  # 우하단
            [126.73507603, 37.33933301]   # 좌하단
        ]
        
        # 중심점 계산
        center_lat = (37.33867727 + 37.33913435 + 37.33945447 + 37.33933301) / 4  # 37.33914977
        center_lon = (126.73485573 + 126.73407843 + 126.73488429 + 126.73507603) / 4  # 126.73472362
        ...
        return [{
            ...
            "coverage_area": {
                "type": "polygon", 
                "coordinates": [[
                    [126.73485573, 37.33867727],  # 좌상
                    [126.73407843, 37.33913435],  # 우상
                    [126.73488429, 37.33945447],  # 우하
                    [126.73507603, 37.33933301],  # 좌하
                    [126.73485573, 37.33867727]   # 폴리곤 닫기
                ]]
            }
        }]
